...
def train_fidec(X, t_grid, basis_generator, n_clusters, hidden_size=32, bottleneck_size=4,
...
def main():
    ...
    features, true_labels = load_data('D:/course/DataScience/FPCA/Project/fDEC/Dataset/Beef/Beef_TEST.txt')
    ...
    # 训练单层函数型IDEC模型
    print('\nRunning One-layer Functional IDEC...')
